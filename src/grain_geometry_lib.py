...
def grain_geometry_finocyl(geometry_scalar,grainlength,armheight,armwidth,numberofarms,graincentreradius,chamber_outer_radius):
    ...
    """
#start conditions
def grain_solver(chamber_outer_radius,typeofgrain,numberofarms,grainlength,graincentreradius,armheight,armwidth):
    if numberofarms == 0:
    ...
    if typeofgrain == 'Addapted Finocyl':
            ...
            for geometry_scalar in geometry_scalars:
                ...
                grainsurfacearea,graincrosssection,volumeofgrain,armheight,armwidthupdate,graincentreradiusupdate,rectanglesubtraction = grain_geometry_finocyl (geometry_scalar, grainlength, armheight, armwidth, numberofarms, graincentreradius, chamber_outer_radius)
    ...
    return regression_vs_Surface_area_curve,regression_vs_grain_cross_section_curve,regression_vs_volume_curve

#grain_solver(chamber_outer_radius,typeofgrain,numberofarms,grainlength,graincentreradius,armheight,armwidth)
''' 
