...
def volume_dot_vap_funct(HEOS, P_tank, m_vap, m_liq, m_dot_vap, m_dot_liq, V_vap, V_liq, T_dot_vap, T_dot_liq):
    ...
    return (combined_term_1 - combined_term_2)/combined_term_3
